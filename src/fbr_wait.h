...
inline static size_t fbr_wait_entries_size_bm(uint32_t entries)
{
	return fbr_bm_alloc_size(entries, sizeof(struct fbr_wait_entry));
}

inline static size_t fbr_wait_entries_size_hp_cache(uint32_t hp_entries)
{
...
inline static size_t fbr_wait_entries_size(uint32_t entries,
					   uint32_t hp_entries)
{
	size_t bm_alloc_size = fbr_wait_entries_size_bm(entries);
	size_t hp_cache_size = fbr_wait_entries_size_hp_cache(hp_entries);
	return bm_alloc_size + hp_cache_size;
}

inline static void fbr_wait_entries_init(struct fbr_wait_entries *w,
