...
#endif /* FIBER_BUILD_OPT_ENV_REL */

#if defined(FIBER_BUILD_OPT_ENV_DEBUG)
#define FIBER_BUILD_ENV_DEBUG_EXISTS (1)
#else
#define FIBER_BUILD_ENV_DEBUG_EXISTS (0)
#endif /* FIBER_BUILD_OPT_ENV_DEBUG */

#if defined(FIBER_BUILD_OPT_ENV_TEST)
#define FIBER_BUILD_ENV_TEST_EXISTS (1)
#else
#define FIBER_BUILD_ENV_TEST_EXISTS (0)
#endif /* FIBER_BUILD_OPT_ENV_TEST */
...
static fiber_bitstring_word capability_bitstring[] = {
	...
	(0 |
	 FIBER_BITSTRING_BIT(FIBER_BUILD_OPT_COMPILE_ASSERTS,
			     FIBER_CAPABILITY_ASSERTS) |
	 FIBER_BITSTRING_BIT(FIBER_BUILD_OPT_COMPILE_FIFO_QUEUE,
			     FIBER_CAPABILITY_FIBER_FIFO_QUEUE) |
	 FIBER_BITSTRING_BIT(FIBER_BUILD_ENV_NORM_EXISTS,
			     FIBER_CAPABILITY_BUILD_ENV_REL) |
...
#undef FIBER_BUILD_ENV_REL_EXISTS
